...
export const INITIAL_CMS: CMSContent = {
  ...
  activities: [
    ...
    { id: '2', title: 'মোটিভেশনাল সেশন', icon: '🧠', image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=800', desc: 'নেশামুক্ত জীবন গঠনের জন্য রোগীদের মাঝে নিয়মিত মোটিভেশনাল ক্লাস আয়োজন।' }
  ],
