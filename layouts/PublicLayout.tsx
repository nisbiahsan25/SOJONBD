...
import { 
  ...
  Activity, Calendar, Building, Sparkles, HeartHandshake, Camera
} from 'lucide-react';
...
const PublicLayout: React.FC<Props> = ({ onGoAdmin, onGoPortal }) => {
  ...
  return (
    <div className="bg-white font-['Hind_Siliguri',_sans-serif]">
      {/* Navbar */}
      <nav className="h-20 flex items-center justify-between px-12 bg-dark-green text-white sticky top-0 z-50 shadow-lg">
        <a 
          href="#home" 
          onClick={(e) => scrollToSection(e, 'home')}
          className="flex items-center gap-2 group cursor-pointer"
        >
          <div className="bg-yellow-accent p-1.5 rounded text-dark-green group-hover:scale-110 transition-transform w-12 h-12 flex items-center justify-center overflow-hidden">
             {cms.logo ? <img src={cms.logo} className="w-full h-full object-contain" alt="Logo" /> : <Activity size={32} />}
          </div>
          <span className="text-2xl font-black tracking-tight text-yellow-accent group-hover:text-white transition-colors">সজন</span>
        </a>
        
        <div className="hidden lg:flex gap-6 font-medium text-xs xl:text-sm">
          <a href="#home" onClick={(e) => scrollToSection(e, 'home')} className="hover:text-yellow-accent transition-colors font-bold">হোম</a>
          <a href="#about" onClick={(e) => scrollToSection(e, 'about')} className="hover:text-yellow-accent transition-colors font-bold">আমাদের সম্পর্কে</a>
          <a href="#services" onClick={(e) => scrollToSection(e, 'services')} className="hover:text-yellow-accent transition-colors font-bold">সেবাসমূহ</a>
          <a href="#activities" onClick={(e) => scrollToSection(e, 'activities')} className="hover:text-yellow-accent transition-colors font-bold">সাম্প্রতিক কার্যক্রম</a>
          <a href="#team" onClick={(e) => scrollToSection(e, 'team')} className="hover:text-yellow-accent transition-colors font-bold">টিম</a>
          <a href="#testimonials" onClick={(e) => scrollToSection(e, 'testimonials')} className="hover:text-yellow-accent transition-colors font-bold">টেস্টিমোনিয়াল</a>
          <a href="#contact" onClick={(e) => scrollToSection(e, 'contact')} className="hover:text-yellow-accent transition-colors font-bold">যোগাযোগ</a>
        ...
        <button 
          onClick={onGoAdmin} 
          className="bg-yellow-accent text-dark-green px-6 py-2 rounded-full font-black text-xs hover:bg-white transition-all shadow-lg active:scale-95"
        >
          এডমিন লগিন
        </button>
      </nav>
      ...
      {/* Hero Section */}
      <section className="relative h-[700px] flex items-center justify-center text-center overflow-hidden bg-dark-green scroll-mt-20" id="home">
        <div className="absolute inset-0 opacity-10">
           <img src={cms?.heroImage} className="w-full h-full object-cover" alt="Background" />
        </div>
        
        <div className="container mx-auto px-8 relative z-10 flex flex-col items-center animate-in">
          <div className="w-24 h-1 bg-yellow-accent mb-12"></div>
          
          <span className="text-yellow-accent font-bold mb-4 text-lg tracking-wide uppercase">গণপ্রজাতন্ত্রী বাংলাদেশ সরকার অনুমোদিত</span>
          
          <h1 className="text-4xl md:text-6xl font-black text-white leading-tight mb-4 max-w-4xl drop-shadow-lg">
            {cms?.heroTitle}
          </h1>
          
          <p className="text-2xl text-emerald-50 mb-12 font-bold border-b-2 border-yellow-accent pb-2">
            {cms?.heroSubtitle}
          </p>
          
          <button 
            onClick={(e) => scrollToSection(e as any, 'contact')}
            className="bg-yellow-accent text-dark-green px-12 py-4 rounded-full font-black text-lg shadow-2xl hover:bg-white transition-all transform hover:-translate-y-1"
          >
            আজই যোগাযোগ করুন
          </button>
        </div>
      ...
      <section className="py-24 bg-white scroll-mt-20" id="about">
        <div className="container mx-auto px-8 text-center">
          <h2 className="text-4xl font-black text-dark-green mb-6">{cms?.aboutTitle}</h2>
          <div className="w-16 h-1 bg-yellow-accent mx-auto mb-10"></div>
          <p className="text-gray-600 max-w-3xl mx-auto leading-relaxed text-xl mb-12 font-medium">
            {cms?.aboutText}
          </p>
      ...
      {/* Services Section */}
      <section className="py-24 bg-gray-50 scroll-mt-20" id="services">
        <div className="container mx-auto px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-dark-green mb-4">{cms?.servicesTitle}</h2>
          ...
          <div className="mt-20 bg-dark-green text-white p-12 rounded-[40px] shadow-2xl relative overflow-hidden">
             ...
             <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-black text-yellow-accent uppercase tracking-widest mb-4">আমাদের লক্ষ্য</h3>
                <p className="text-2xl md:text-4xl font-bold max-w-4xl leading-relaxed drop-shadow-md">
      ...
      <section className="py-24 bg-white scroll-mt-20" id="activities">
        <div className="container mx-auto px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-dark-green mb-4">🟢 {cms?.activitiesTitle}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {(cms?.activities || []).map((act, i) => (
              <div key={act.id} className="bg-white rounded-[40px] shadow-lg border border-gray-50 overflow-hidden hover:shadow-2xl transition-all group flex flex-col h-full">
                <div className="h-64 relative overflow-hidden">
                   ...
                   />
                   <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm p-3 rounded-2xl shadow-lg flex items-center justify-center text-3xl">
                     {act.icon}
                   </div>
            ...
            <div className="lg:col-span-1 bg-dark-green p-10 rounded-[40px] shadow-xl flex flex-col justify-center text-center relative overflow-hidden group min-h-[400px]">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white text-xl font-bold leading-relaxed mb-8 italic drop-shadow-lg">
      ...
      {/* Specialist Team */}
      <section className="py-24 bg-gray-50 scroll-mt-20" id="team">
        <div className="container mx-auto px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-dark-green mb-4">{cms?.teamTitle}</h2>
      ...
      <section className="py-24 bg-dark-green scroll-mt-20" id="testimonials">
        <div className="container mx-auto px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-white mb-4">{cms?.testimonialsTitle}</h2>
            <div className="w-16 h-1 bg-yellow-accent mx-auto"></div>
          </div>
      ...
      <footer className="bg-[#111] text-white py-20 px-12 scroll-mt-20" id="contact">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          <div>
            ...
            <div className="flex gap-6">
              <a href={cms?.facebookLink} className="w-14 h-14 rounded-2xl bg-white/10 flex items-center justify-center hover:bg-yellow-accent hover:text-dark-green transition-all transform hover:-translate-y-1 shadow-lg">
                <Facebook size={28} />
              </a>
            </div>
          </div>
        ...
        <div className="mt-20 pt-10 border-t border-white/5 text-center text-gray-600 text-sm font-bold uppercase tracking-[0.3em]">
