...
import { AppState, Patient, Bed, InventoryItem, BillingRecord, Visitor, DoctorChart, Complaint, CMSContent, Role, PaymentMethod, SystemUser, DietPlan, Incident, RosterEntry } from './types';
...
const FIXED_ROLES: Role[] = [
  ...
  { id: '3', name: 'Accounts Manager', permissions: ['Dashboard', 'Inventory', 'Billing', 'Daily Report'] },
...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <AppContext.Provider value={{
      ...
      addBilling, addVisitor, addDoctorChart, updateDoctorChart, addComplaint, updateComplaint, updateCMS,
      addRole, updateRole, deleteRole, addPaymentMethod, togglePaymentStatus, addUser, deleteUser,
      addDietPlan, updateDietPlan, addIncident, updateIncident, addRosterEntry, deleteRosterEntry
    }}>
      {children}
    </AppContext.Provider>
  );
